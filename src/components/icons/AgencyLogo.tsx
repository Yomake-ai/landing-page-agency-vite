...
export const AgencyLogo = (props: HTMLAttributes<HTMLDivElement>) => (
  <div className={`flex items-center gap-2 min-w-max ${props.className || ''}`} {...props}>
    <svg
      viewBox="0 0 42 42"
      fill="none"
    ...
    <span className="text-lg font-bold text-gray-900 flex-shrink-0">Agency</span>
  </div>
)
