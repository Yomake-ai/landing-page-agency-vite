...
const Footer = () => {
  const sections = {
    ...
    connect: {
      title: "Connect",
      items: [
        { label: "Free Consultation", href: "#", external: true },
        { label: "Project Inquiry", href: "#", external: true },
        { label: "Partnership", href: "#", external: true },
    ...
    <div className="px-4 xl:px-0">
      ...
      >
        ...
        <div className="mr-auto flex w-full justify-between lg:w-fit lg:flex-col">
          ...
          >
            <AgencyLogo className="ml-2 w-20" />

            <span className="sr-only">Agency Logo (go home)</span>
          </Link>
          ...
          <div>
            ...
            <div className="ml-2 hidden text-sm text-gray-700 lg:inline">
              &copy; {CURRENT_YEAR} Creative Agency, Inc.
            </div>
          </div>
        </div>
