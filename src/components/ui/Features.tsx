...
import { AgencyMark } from "@/components/icons/AgencyMark"
...
export default function Features() {
  return (
    <section
      aria-label="Creative Agency Services"
      id="services"
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative text-lg font-semibold tracking-tight text-[#003566]">
            Our Services
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Full-service digital solutions that deliver results
          </p>
          <p className="mt-4 text-balance text-gray-700">
            From brand identity to web development, we provide comprehensive
            digital services that help businesses stand out and grow in the
            digital landscape.
          </p>
        </div>
            ...
            <div className="relative flex flex-col items-center justify-center">
              <Orbit
                ...
                orbitingObjects={[
                  ...
                  >
                    <RiBrushLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-[#003566]/5"></div>
                    ...
                    <div
                      ...
                      className="absolute size-10 animate-[ping_7s_ease_infinite] rounded-full ring-1 ring-[#003566]/50"
                    ></div>
                  </div>,
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiCodeSSlashLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-[#003566]/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiSearchLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-[#003566]/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiRocketLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-[#003566]/5"></div>
                    <div
                      style={{
                        animationDelay: "3s",
              ...
              >
                <div className="relative flex h-48 w-48 items-center justify-center">
                  <div className="rounded-full p-1 ring-1 ring-black/10">
                    <div className="relative z-10 flex size-20 items-center justify-center rounded-full bg-white ring-1 shadow-[inset_0px_-15px_20px_rgba(0,53,102,0.1),0_7px_10px_0_rgba(0,53,102,0.15)] ring-black/20">
                      <AgencyMark className="size-10" />
                    </div>
                    <div className="absolute inset-12 animate-[spin_8s_linear_infinite] rounded-full bg-linear-to-t from-transparent via-[#ffc300] to-transparent blur-lg" />
                  </div>
                </div>
              </Orbit>
            </div>
          ...
          <div className="relative h-[432px] w-[432px]">
            ...
            <div className="pointer-events-none relative h-full select-none">
              <div className="absolute top-[192px] left-[191.8px]">
                <div className="flex h-12 w-12 items-center justify-center bg-white ring-1 shadow-sm ring-[#003566]/15">
                  <AgencyMark className="h-8 w-8" />
                </div>
              </div>
              <div className="absolute top-[144px] left-[48px]">
                <div className="relative">
                  <div className="absolute inset-0 size-12 animate-pulse bg-[#ffc300]/30 blur-[3px]"></div>
                  <div className="relative flex h-12 w-12 items-center justify-center bg-white ring-1 shadow-sm ring-[#003566]/15">
        ...
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative text-lg font-semibold tracking-tight text-[#003566]">
            Easy Expansion
            <div className="absolute top-1 -left-[7px] h-5 w-[3px] rounded-r-sm bg-[#003566]" />
          </h2>
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Scale your digital presence effortlessly
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Expand your digital capabilities with seamless integration across
            all platforms. Our solutions automatically sync and optimize
          ...
          <div className="pointer-events-none relative flex size-full h-[26rem] items-center justify-center p-10 select-none">
            <div className="relative">
              <div className="absolute top-[6rem] left-[6rem] z-20">
                <div className="relative mx-auto w-fit rounded-full bg-gray-50 p-1 ring-1 shadow-md shadow-[#003566]/10 ring-[#003566]/10">
                  <div className="w-fit rounded-full bg-linear-to-b from-white to-gray-100 p-3 ring-1 shadow-[inset_0px_-2px_6px_rgba(0,53,102,0.09),0_3px_5px_0_rgba(0,53,102,0.19)] ring-white/50 ring-inset">
                    <RiNotification2Line
              ...
              <div className="absolute top-[6rem] right-[6rem] z-20">
                <div className="relative mx-auto w-fit rounded-full bg-gray-50 p-1 ring-1 shadow-md shadow-[#003566]/10 ring-[#003566]/10">
                  <div className="w-fit rounded-full bg-linear-to-b from-white to-gray-100 p-3 ring-1 shadow-[inset_0px_-2px_6px_rgba(0,53,102,0.05),0_7px_10px_0_rgba(0,53,102,0.10)] ring-white/50 ring-inset">
                    <RiContrast2Line
                      className="size-5 text-gray-900"
                      aria-hidden="true"
                    />
              ...
              {[0, 45, 135, 180, 225, 315, 360].map((rotation, index) => (
                ...
                >
                  <div className="relative">
                    ...
                    <div
                      className="absolute top-0 left-0 h-0.5 w-28 bg-linear-to-r from-transparent via-[#ffc300] to-transparent"
                      style={{
